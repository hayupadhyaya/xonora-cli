...
All releases are published on the [GitHub Releases](https://github.com/hayupadhyaya/xonora-cli/releases) page.
...
|---|---|---|
| [cli-v0.3.10](https://github.com/hayupadhyaya/xonora-cli/releases/tag/cli-v0.3.10) | 2026-04-19 | Native Windows binary, clock-synced group playback, keybinding overhaul, Party + API Console tabs, codec switching |
| [cli-v0.2.0](https://github.com/hayupadhyaya/xonora-cli/releases/tag/cli-v0.2.0) | 2026-04-15 | Cross-platform audio (miniaudio), Linux binaries, WSL support |

See [CHANGELOG](https://github.com/hayupadhyaya/xonora-cli/blob/main/CHANGELOG-cli.md) for full release notes.

## Installation instructions

See [Install](Install) for platform-specific setup steps.
